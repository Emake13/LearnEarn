...
const TOTAL_BALANCE = 96000;
const AVAILABLE_BALANCE = 96000;

/** Formats a number as Naira with two decimals, e.g. ₦96,000.00 */
...
export function WalletCard() {
  ...
  const handleToggle = () => {
    setVisible((v) => {
      console.log("[WalletCard] balance visibility toggled ->", !v);
      return !v;
    });
  };

  const handleWithdraw = () => {
    console.log("[WalletCard] withdraw tapped", {
  ...
  return (
    <section className="le-rise relative mt-6" style={{ animationDelay: "140ms" }}>
      {/* Gradient mesh bloom sitting behind the glass */}
      ...
      <div className="le-glass le-grain relative overflow-hidden rounded-[28px] p-6 pt-5">
        {/* Decorative floating wallet + naira coins, top-right */}
        <div
          aria-hidden
